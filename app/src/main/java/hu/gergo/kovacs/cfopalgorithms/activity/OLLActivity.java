...
public class OLLActivity extends YouTubeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinatorLayout = (CoordinatorLayout) findViewById(R.id.oll_coordinator);
        appBarLayout = (AppBarLayout) findViewById(R.id.oll_appbar);

        TypedValue outValue = new TypedValue();
        getResources().getValue(R.dimen.oll_toolbar_offset_scale, outValue, true);
        appbarOffsetScale = outValue.getFloat();

        appBarLayout.post(new Runnable() {
            @Override
            public void run() {
                int heightPx = findViewById(R.id.oll_toolbar_layout).getHeight();
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void loadVideo() {
                ViewStub viewStub = (ViewStub) findViewById(R.id.oll_youtube_view_stub);
                viewStub.inflate();
                ...
                youTubePlayerView.initialize(YoutubePlayerConfig.API_KEY,
                        ...
                        new YouTubePlayer.OnInitializedListener() {
                            ...
                            public void onInitializationSuccess(YouTubePlayer.Provider provider,
                                ...
                                youTubePlayer.cueVideo(getResources().getString(R.string.oll_youtube_video_url));
                            }

                            @Override
                            public void onInitializationFailure(YouTubePlayer.Provider provider,
                                                                YouTubeInitializationResult youTubeInitializationResult) {
                                Toast.makeText(OLLActivity.this, "Youtube Failed!", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        ...
        appBarText = (TextView) findViewById(R.id.oll_appbar_text);
    ...
    public void setupListView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent intent = new Intent(OLLActivity.this, AlgorithmDetailActivity.class);
